      ...
      <form wire:submit.prevent="store" x-data="{role_id: 1}">
         ...
         <div class="flex flex-col sm:grid sm:gap-6 mt-4 sm:grid-cols-2">
            ...
            <div wire:ignore class="mt-2 sm:mt-0">
               ...
               {{-- <input type="text" wire:model="institution" id="institution"
                  class="relative m-auto w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">

               <div class="relative z-20 top-2">
                  <ul class="absolute w-full bg-gray-100 px-2 border border-gray-300 rounded-md">
                     <li class="py-1">Universitas Ubudiyah Indonesia</li>
                     <li class="py-1">Universitas Syiah Kuala</li>
                  </ul>
               </div> --}}
