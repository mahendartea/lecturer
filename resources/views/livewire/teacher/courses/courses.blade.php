  ...
  <header class="shadow bg-white rounded-b-md z-10 mb-5">
    <div class="mx-auto py-7 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center">
        <div class="flex">
          <div wire:click="toHistoryCourses" class="flex justify-start mx-2 text-gray-500  hover:text-gray-600
          ...
          <div wire:click="toCounseling" class="flex justify-start mx-2 text-gray-500  hover:text-gray-600
          ...
          <div wire:click="toTimeTable" class="flex justify-start mx-2 text-gray-500  hover:text-gray-600
        ...
        <div>
          <div {{-- wire:click="toCoursesIndex" --}} class="flex justify-start mx-2 text-gray-500  hover:text-gray-600
