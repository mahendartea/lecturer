            ...
            <div>
               <div class="grid grid-cols-1 gap-2 mt-4 sm:grid-cols-2">
                  <div class="px-2 my-2">
                     ...
                     <x-jet-input id="name" class="m-auto w-full" type="text" name="name" :value="old('name')" autofocus
                        autocomplete="name" />
                     @error('name') <span
                  ...
                  <div class="px-2 my-2">
                     ...
                     <x-jet-input id="email" class="m-auto w-full" type="email" name="email" :value="old('email')" />
                     @error('email') <span
                           class="error text-center mt-1 text-red-600 text-xs italic">{{ $message }}</span>
                     @enderror
                  </div>
                  ...
                  <div class="p-2" x-show="status_pt == 1">
                     <x-jet-label for="institution" value="{{ __('Universitas / Institusi Negeri') }}" />
                     @php $dataPt = App\Models\Dataptn::all() @endphp
                     <select name="institution"
                        class="select-search m-auto w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
