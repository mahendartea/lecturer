...
class PtnsIndex extends Component
{
    use WithPagination;
    public $paginate = 10;
    public $search;
    ...
    {
        if ($this->search == null) {
            return view('livewire.admin.ptns.ptns-index', ['ptns' => Dataptn::paginate($this->paginate)]);
        } else {
            return view('livewire.admin.ptns.ptns-index', ['ptns' => Dataptn::where('nama_universitas', 'like', '%' . $this->search . '%')->paginate($this->paginate)]);
        }
    }
